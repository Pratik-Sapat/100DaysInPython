...
class Snake:
    ...
    def reset(self):
        for seg in self.segments:
            seg.goto(1000,1000) #go snake off screen after game end.
        self.segments.clear()
        self.create_snake()
        self.head = self.segments[0] 
    ...
    def extend(self):
        ...
        self.add_segment(self.segments[-1].position()) #last segment of list and hold it using turtle class method position()
